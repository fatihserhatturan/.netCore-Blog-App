        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AboutContent = table.Column<string>(maxLength: 500, nullable: true),
                    AboutContent2 = table.Column<string>(maxLength: 500, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    AdminD = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Admins", x => x.AdminD);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AuthorImage = table.Column<string>(maxLength: 100, nullable: true),
                    AuthorAbout = table.Column<string>(maxLength: 250, nullable: true)
                },
                constraints: table =>
                {
